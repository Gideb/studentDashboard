...
const Dashboard = () => {
  return (
    <div className='max-w-7xl mx-auto p-10'>
      <div className='mb-6'>
        <h1 className='text-2xl font-bold text-gray-900 dark:text-white'>Good morning, John 👋</h1>
      ...
      <div className='space-y-4 my-3 px-6  py-8  bg-gray-50 dark:bg-slate-950 rounded-lg'>
        <div className='flex items-center justify-start gap-3'>
          ...
          <h3 className='text-xl text-teal-800 dark:text-teal-200 font-semibold'>Recent Results</h3>
        </div>
