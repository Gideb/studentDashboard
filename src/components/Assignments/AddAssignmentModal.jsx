        ...
        <form onSubmit={handleSubmit} className='space-y-3'>
          ...
          <div>
            ...
            <input
              ...
              className={`input-box ${
                errors.title
                  ? 'border-red-500'
                  : 'border-gray-200 focus:border-primary dark:focus:border-dark dark:border-gray-700'
              }`}
            />
          ...
          <div>
            ...
            >
              ...
              {courses.map(course => (
                <option key={course} value={course} className='dark:bg-gray-800 dark:text-gray-200'>
                  {course}
                </option>
              ))}
            </select>
