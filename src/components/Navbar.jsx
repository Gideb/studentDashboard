      ...
      <div className='max-w-8xl flex justify-between md:justify-end gap-5 items-center'>
        ...
        <div className='flex justify-center gap-2 md:hidden'>
          <button type='button' onClick={toggleMobileMenu} aria-label='open side menu'>
            <PiSidebarSimpleDuotone className='text-xl text-primary dark:text-dark cursor-pointer' />
          </button>

          <img src={darkMode ? smd_logo_dark : smd_logo} alt='SMD logo' className='w-10' />
        </div>
